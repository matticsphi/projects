...
public class AdminLogin {
  ...
  public void testAdminLogin() throws Exception {
    ...
    driver.findElement(By.id("ContentPlaceHolder1_txtPassword")).sendKeys("rajesh");
    driver.findElement(By.id("ContentPlaceHolder1_txtUserName")).clear();
    driver.findElement(By.id("ContentPlaceHolder1_txtUserName")).sendKeys("rajesh");
